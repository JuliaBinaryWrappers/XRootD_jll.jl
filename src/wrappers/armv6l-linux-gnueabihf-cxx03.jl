# Autogenerated wrapper script for XRootD_jll for armv6l-linux-gnueabihf-cxx03
export cconfig, cmsd, frm_admin, frm_purged, frm_xfragent, frm_xfrd, libXrdAppUtils, libXrdBlacklistDecision, libXrdBwm, libXrdCksCalczcrc32, libXrdCl, libXrdClProxyPlugin, libXrdCmsRedirectLocal, libXrdCrypto, libXrdCryptoLite, libXrdCryptossl, libXrdFfs, libXrdHttp, libXrdHttpUtils, libXrdN2No2p, libXrdOfsPrepGPI, libXrdOssCsi, libXrdOssSIgpfsT, libXrdPfc, libXrdPosix, libXrdPosixPreload, libXrdPss, libXrdSec, libXrdSecProt, libXrdSecgsiAUTHZVO, libXrdSecgsiGMAPDN, libXrdSecpwd, libXrdSecunix, libXrdServer, libXrdSsi, libXrdSsiLib, libXrdSsiLog, libXrdSsiShMap, libXrdThrottle, libXrdUtils, libXrdXml, libXrdXrootd, libXrfSecgsi, libXrfSecsss, mpxstats, wait41, xrdacctest, xrdadler32, xrdcp, xrdcrc32c, xrdfs, xrdgsiproxy, xrdgsitest, xrdmapc, xrdpfc_print, xrdpinls, xrdpwdadmin, xrdsssadmin, xrootd
...
JLLWrappers.@declare_library_product(libXrdBlacklistDecision, "libXrdBlacklistDecision-5.so")
JLLWrappers.@declare_library_product(libXrdBwm, "libXrdBwm-5.so")
JLLWrappers.@declare_library_product(libXrdCksCalczcrc32, "libXrdCksCalczcrc32-5.so")
JLLWrappers.@declare_library_product(libXrdCl, "libXrdCl.so.3")
JLLWrappers.@declare_library_product(libXrdClProxyPlugin, "libXrdClProxyPlugin-5.so")
JLLWrappers.@declare_library_product(libXrdCmsRedirectLocal, "libXrdCmsRedirectLocal-5.so")
...
JLLWrappers.@declare_library_product(libXrdCryptossl, "libXrdCryptossl-5.so")
JLLWrappers.@declare_library_product(libXrdFfs, "libXrdFfs.so.3")
JLLWrappers.@declare_library_product(libXrdHttp, "libXrdHttp-5.so")
JLLWrappers.@declare_library_product(libXrdHttpUtils, "libXrdHttpUtils.so.2")
JLLWrappers.@declare_library_product(libXrdN2No2p, "libXrdN2No2p-5.so")
JLLWrappers.@declare_library_product(libXrdOfsPrepGPI, "libXrdOfsPrepGPI-5.so")
JLLWrappers.@declare_library_product(libXrdOssCsi, "libXrdOssCsi-5.so")
JLLWrappers.@declare_library_product(libXrdOssSIgpfsT, "libXrdOssSIgpfsT-5.so")
JLLWrappers.@declare_library_product(libXrdPfc, "libXrdPfc-5.so")
...
JLLWrappers.@declare_library_product(libXrdPss, "libXrdPss-5.so")
JLLWrappers.@declare_library_product(libXrdSec, "libXrdSec-5.so")
JLLWrappers.@declare_library_product(libXrdSecProt, "libXrdSecProt-5.so")
JLLWrappers.@declare_library_product(libXrdSecgsiAUTHZVO, "libXrdSecgsiAUTHZVO-5.so")
JLLWrappers.@declare_library_product(libXrdSecgsiGMAPDN, "libXrdSecgsiGMAPDN-5.so")
JLLWrappers.@declare_library_product(libXrdSecpwd, "libXrdSecpwd-5.so")
JLLWrappers.@declare_library_product(libXrdSecunix, "libXrdSecunix-5.so")
JLLWrappers.@declare_library_product(libXrdServer, "libXrdServer.so.3")
JLLWrappers.@declare_library_product(libXrdSsi, "libXrdSsi-5.so")
JLLWrappers.@declare_library_product(libXrdSsiLib, "libXrdSsiLib.so.2")
JLLWrappers.@declare_library_product(libXrdSsiLog, "libXrdSsiLog-5.so")
JLLWrappers.@declare_library_product(libXrdSsiShMap, "libXrdSsiShMap.so.2")
JLLWrappers.@declare_library_product(libXrdThrottle, "libXrdThrottle-5.so")
...
JLLWrappers.@declare_library_product(libXrdXrootd, "libXrdXrootd-5.so")
JLLWrappers.@declare_library_product(libXrfSecgsi, "libXrdSecgsi-5.so")
JLLWrappers.@declare_library_product(libXrfSecsss, "libXrdSecsss-5.so")
