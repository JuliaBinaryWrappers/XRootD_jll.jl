# Autogenerated wrapper script for XRootD_jll for aarch64-apple-darwin
...
function __init__()
    ...
    JLLWrappers.@init_library_product(
        libXrdAppUtils,
        "lib/libXrdAppUtils.2.0.0.dylib",
    ...
    JLLWrappers.@init_library_product(
        libXrdHttpUtils,
        "lib/libXrdHttpUtils.2.0.0.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
    ...
    JLLWrappers.@init_library_product(
        libXrdPosix,
        "lib/libXrdPosix.3.0.0.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libXrdPosixPreload,
        "lib/libXrdPosixPreload.2.0.0.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
    ...
    JLLWrappers.@init_library_product(
        libXrdSsiShMap,
        "lib/libXrdSsiShMap.2.0.0.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
